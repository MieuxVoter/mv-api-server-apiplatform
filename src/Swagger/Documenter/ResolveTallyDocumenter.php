...
// TODO: Response Model
// TODO: Path parameter requirements

class ResolveTallyDocumenter implements DocumenterInterface
{
            ...
            'paths' => [
                $path => [
                    $method => [
                        ...
                        'summary' => $this->trans('oas.resolve_tally.summary'),
                        'description' => $this->trans('oas.resolve_tally.description'),
                        'responses' => [
                            Response::HTTP_OK => [
                                'description' => $this->trans('oas.resolve_tally.response.ok'),
                            ],
